...
DLL_EXPORT HRESULT DirectSoundCaptureEnumerateW(void* pDSEnumCallback, LPVOID pContext) {
...
DLL_EXPORT HRESULT GetDeviceID(LPCGUID pGuidSrc, LPGUID pGuidDest) {
    return reinterpret_cast<decltype(&GetDeviceID)>(get_device_id_ptr)(pGuidSrc, pGuidDest);
}

DLL_EXPORT HRESULT DirectSoundFullDuplexCreate(LPCGUID pcGuidCaptureDevice,
...
DLL_EXPORT HRESULT DirectSoundCreate8(LPCGUID pcGuidDevice, void** ppDS8, void* pUnkOuter) {
    return reinterpret_cast<decltype(&DirectSoundCreate8)>(direct_sound_create_8_ptr)(
        pcGuidDevice, ppDS8, pUnkOuter);
}

DLL_EXPORT HRESULT DirectSoundCaptureCreate8(LPCGUID pcGuidDevice, void** ppDSC8, void* pUnkOuter) {
